...
function select(transactions, commodity, start_date, end_date) {
    return transactions.reduce(function (list, transaction) {
        if (!in_date_range(transaction.date, start_date, end_date)) {
            return list;
        }
        ...
        transaction.postings.forEach(function (posting) {
            if (posting.amount.commodity === commodity) {
                list.push({
                    date: transaction.date,
                    value: posting.amount.quantity,
                });
...
function exists(transactions, commodity, start_date, end_date) {
    return transactions.reduce(function (list, transaction) {
        if (!in_date_range(transaction.date, start_date, end_date)) {
            return list;
        }
...
exports.sample_by_count = function (
    commodity,
    start_date,
    count,
    interval,
